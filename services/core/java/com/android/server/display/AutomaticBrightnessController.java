...
public class AutomaticBrightnessController {
    ...
    public void configure(int state, @Nullable BrightnessConfiguration configuration,
        ...
        configure(state, configuration, brightness, userChangedBrightness, adjustment,
                userChangedAutoBrightnessAdjustment, displayPolicy, displayState,
                useNormalBrightnessForDoze, shouldResetShortTermModel,
                false /* autoBrightnessOneShot */);
    }
